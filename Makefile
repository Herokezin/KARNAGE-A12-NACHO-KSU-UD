...
ARCH		?=arm64
ROSS_COMPILE   ?= $(srctree)/Pronton-toolchains/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld
CC      = $(srctree)/Pronton-toolchains/clang/host/linux-x86/clang-r416183d/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
