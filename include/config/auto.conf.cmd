...
ifneq "$(CC_VERSION_TEXT)" "Android (7449660, based on r416183d) clang version 12.0.7 (https://android.googlesource.com/toolchain/llvm-project c935d99d7cf2016289302412d708641d52d2f7ee)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "./clang-r416183d/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "./aarch64-linux-android-4.9-llvm/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "./aarch64-linux-android-4.9-llvm/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "./aarch64-linux-android-4.9-llvm/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" " --target=aarch64-linux-gnu --prefix=./aarch64-linux-android-4.9-llvm/bin/ --gcc-toolchain=/home/herokelc/MizKernel-GalaxyA12s-stable/aarch64-linux-android-4.9-llvm -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
